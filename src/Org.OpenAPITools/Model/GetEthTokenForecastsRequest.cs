...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "getEthTokenForecasts_request")]
    public partial class GetEthTokenForecastsRequest : IEquatable<GetEthTokenForecastsRequest>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetEthTokenForecastsRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetEthTokenForecastsRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetEthTokenForecastsRequest" /> class.
        /// </summary>
        ...
        public GetEthTokenForecastsRequest(string collectionAddress = default(string), List<string> tokenId = default(List<string>), VoltypeEnum? voltype = default(VoltypeEnum?), int horizon = default(int), string frequency = default(string), DistEnum? dist = default(DistEnum?), string startDate = default(string), string endDate = default(string), bool returnPriceForecasts = default(bool), decimal alpha = default(decimal), ReptCurrEnum? reptCurr = default(ReptCurrEnum?), bool excludeWash = default(bool), GetEthCollectionForecastsRequestArchParams archParams = default(GetEthCollectionForecastsRequestArchParams))
        {
            // to ensure "collectionAddress" is required (not null)
            if (collectionAddress == null)
            {
                throw new ArgumentNullException("collectionAddress is a required property for GetEthTokenForecastsRequest and cannot be null");
            }
            this.CollectionAddress = collectionAddress;
            // to ensure "tokenId" is required (not null)
            if (tokenId == null)
            {
                throw new ArgumentNullException("tokenId is a required property for GetEthTokenForecastsRequest and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetEthTokenForecastsRequest {\n");
        ...
        {
            return this.Equals(input as GetEthTokenForecastsRequest);
        }

        /// <summary>
        /// Returns true if GetEthTokenForecastsRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of GetEthTokenForecastsRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetEthTokenForecastsRequest input)
        {
            if (input == null)
            {
                return false;
