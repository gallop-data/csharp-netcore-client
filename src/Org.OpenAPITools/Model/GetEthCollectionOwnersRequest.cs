...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "getEthCollectionOwners_request")]
    public partial class GetEthCollectionOwnersRequest : IEquatable<GetEthCollectionOwnersRequest>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetEthCollectionOwnersRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetEthCollectionOwnersRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetEthCollectionOwnersRequest" /> class.
        /// </summary>
        ...
        public GetEthCollectionOwnersRequest(string collectionAddress = default(string), int page = default(int), PageSizeEnum? pageSize = default(PageSizeEnum?))
        {
            // to ensure "collectionAddress" is required (not null)
            if (collectionAddress == null)
            {
                throw new ArgumentNullException("collectionAddress is a required property for GetEthCollectionOwnersRequest and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetEthCollectionOwnersRequest {\n");
        ...
        {
            return this.Equals(input as GetEthCollectionOwnersRequest);
        }

        /// <summary>
        /// Returns true if GetEthCollectionOwnersRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of GetEthCollectionOwnersRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetEthCollectionOwnersRequest input)
        {
            if (input == null)
            {
                return false;
