...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "getEthCustomCollectionRisk_request_arc_params")]
    public partial class GetEthCustomCollectionRiskRequestArcParams : IEquatable<GetEthCustomCollectionRiskRequestArcParams>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetEthCustomCollectionRiskRequestArcParams" /> class.
        /// </summary>
        ...
        public GetEthCustomCollectionRiskRequestArcParams(string mean = default(string), int lags = default(int), string vol = default(string), int p = default(int), DistEnum? dist = default(DistEnum?))
        {
            this.Mean = mean;
            this.Lags = lags;
            this.Vol = vol;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetEthCustomCollectionRiskRequestArcParams {\n");
        ...
        {
            return this.Equals(input as GetEthCustomCollectionRiskRequestArcParams);
        }

        /// <summary>
        /// Returns true if GetEthCustomCollectionRiskRequestArcParams instances are equal
        /// </summary>
        /// <param name="input">Instance of GetEthCustomCollectionRiskRequestArcParams to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetEthCustomCollectionRiskRequestArcParams input)
        {
            if (input == null)
            {
                return false;
