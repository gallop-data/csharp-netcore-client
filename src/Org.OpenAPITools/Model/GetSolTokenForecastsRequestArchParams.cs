...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "getSolTokenForecasts_request_arch_params")]
    public partial class GetSolTokenForecastsRequestArchParams : IEquatable<GetSolTokenForecastsRequestArchParams>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetSolTokenForecastsRequestArchParams" /> class.
        /// </summary>
        ...
        public GetSolTokenForecastsRequestArchParams(string mean = default(string), int lags = default(int), string vol = default(string), int p = default(int), DistEnum? dist = default(DistEnum?))
        {
            this.Mean = mean;
            this.Lags = lags;
            this.Vol = vol;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetSolTokenForecastsRequestArchParams {\n");
        ...
        {
            return this.Equals(input as GetSolTokenForecastsRequestArchParams);
        }

        /// <summary>
        /// Returns true if GetSolTokenForecastsRequestArchParams instances are equal
        /// </summary>
        /// <param name="input">Instance of GetSolTokenForecastsRequestArchParams to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetSolTokenForecastsRequestArchParams input)
        {
            if (input == null)
            {
                return false;
