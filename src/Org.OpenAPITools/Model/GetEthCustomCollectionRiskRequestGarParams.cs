...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "getEthCustomCollectionRisk_request_gar_params")]
    public partial class GetEthCustomCollectionRiskRequestGarParams : IEquatable<GetEthCustomCollectionRiskRequestGarParams>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetEthCustomCollectionRiskRequestGarParams" /> class.
        /// </summary>
        ...
        public GetEthCustomCollectionRiskRequestGarParams(string mean = default(string), int lags = default(int), string vol = default(string), int p = default(int), DistEnum? dist = default(DistEnum?))
        {
            this.Mean = mean;
            this.Lags = lags;
            this.Vol = vol;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetEthCustomCollectionRiskRequestGarParams {\n");
        ...
        {
            return this.Equals(input as GetEthCustomCollectionRiskRequestGarParams);
        }

        /// <summary>
        /// Returns true if GetEthCustomCollectionRiskRequestGarParams instances are equal
        /// </summary>
        /// <param name="input">Instance of GetEthCustomCollectionRiskRequestGarParams to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetEthCustomCollectionRiskRequestGarParams input)
        {
            if (input == null)
            {
                return false;
