...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "getPolCollectionTransactions_request")]
    public partial class GetPolCollectionTransactionsRequest : IEquatable<GetPolCollectionTransactionsRequest>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetPolCollectionTransactionsRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetPolCollectionTransactionsRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetPolCollectionTransactionsRequest" /> class.
        /// </summary>
        ...
        public GetPolCollectionTransactionsRequest(string collectionAddress = default(string), int page = default(int), PageSizeEnum? pageSize = default(PageSizeEnum?), int startBlockNumber = default(int), string startDate = default(string), string endDate = default(string))
        {
            // to ensure "collectionAddress" is required (not null)
            if (collectionAddress == null)
            {
                throw new ArgumentNullException("collectionAddress is a required property for GetPolCollectionTransactionsRequest and cannot be null");
            }
        ...
        /// <example>&quot;0x0833566d5c6926ba123f6587fb16ff4aa8d7680b&quot;</example>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetPolCollectionTransactionsRequest {\n");
        ...
        {
            return this.Equals(input as GetPolCollectionTransactionsRequest);
        }

        /// <summary>
        /// Returns true if GetPolCollectionTransactionsRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of GetPolCollectionTransactionsRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetPolCollectionTransactionsRequest input)
        {
            if (input == null)
            {
                return false;
