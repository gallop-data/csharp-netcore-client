...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "getSolCollectionSalesOHLC_request")]
    public partial class GetSolCollectionSalesOHLCRequest : IEquatable<GetSolCollectionSalesOHLCRequest>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetSolCollectionSalesOHLCRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetSolCollectionSalesOHLCRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetSolCollectionSalesOHLCRequest" /> class.
        /// </summary>
        ...
        public GetSolCollectionSalesOHLCRequest(string collectionTag = default(string), string frequency = default(string), string groupBy = default(string), bool volume = default(bool), ReptCurrEnum? reptCurr = default(ReptCurrEnum?), string startDate = default(string), string endDate = default(string), bool excludeWash = default(bool))
        {
            // to ensure "collectionTag" is required (not null)
            if (collectionTag == null)
            {
                throw new ArgumentNullException("collectionTag is a required property for GetSolCollectionSalesOHLCRequest and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetSolCollectionSalesOHLCRequest {\n");
        ...
        {
            return this.Equals(input as GetSolCollectionSalesOHLCRequest);
        }

        /// <summary>
        /// Returns true if GetSolCollectionSalesOHLCRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of GetSolCollectionSalesOHLCRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetSolCollectionSalesOHLCRequest input)
        {
            if (input == null)
            {
                return false;
