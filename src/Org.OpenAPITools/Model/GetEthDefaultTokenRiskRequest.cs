...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "getEthDefaultTokenRisk_request")]
    public partial class GetEthDefaultTokenRiskRequest : IEquatable<GetEthDefaultTokenRiskRequest>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetEthDefaultTokenRiskRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetEthDefaultTokenRiskRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetEthDefaultTokenRiskRequest" /> class.
        /// </summary>
        ...
        public GetEthDefaultTokenRiskRequest(string collectionAddress = default(string), List<string> tokenId = default(List<string>), string holdingPeriod = default(string), ReptCurrEnum? reptCurr = default(ReptCurrEnum?), bool drawdown = default(bool))
        {
            // to ensure "collectionAddress" is required (not null)
            if (collectionAddress == null)
            {
                throw new ArgumentNullException("collectionAddress is a required property for GetEthDefaultTokenRiskRequest and cannot be null");
            }
            this.CollectionAddress = collectionAddress;
            // to ensure "tokenId" is required (not null)
            if (tokenId == null)
            {
                throw new ArgumentNullException("tokenId is a required property for GetEthDefaultTokenRiskRequest and cannot be null");
            }
            this.TokenId = tokenId;
            // to ensure "holdingPeriod" is required (not null)
            if (holdingPeriod == null)
            {
                throw new ArgumentNullException("holdingPeriod is a required property for GetEthDefaultTokenRiskRequest and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetEthDefaultTokenRiskRequest {\n");
        ...
        {
            return this.Equals(input as GetEthDefaultTokenRiskRequest);
        }

        /// <summary>
        /// Returns true if GetEthDefaultTokenRiskRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of GetEthDefaultTokenRiskRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetEthDefaultTokenRiskRequest input)
        {
            if (input == null)
            {
                return false;
