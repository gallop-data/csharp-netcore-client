...
namespace Org.OpenAPITools.Model
{
    ...
    /// GetPolTokensRequest
    /// </summary>
    [DataContract(Name = "getPolTokens_request")]
    public partial class GetPolTokensRequest : IEquatable<GetPolTokensRequest>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetPolTokensRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetPolTokensRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetPolTokensRequest" /> class.
        /// </summary>
        /// <param name="collectionAddress">The contract address of the token collection. (required).</param>
        /// <param name="tokenId">A list of token ids..</param>
        /// <param name="page">The pagination cursor..</param>
        /// <param name="pageSize">The number of records returned per page..</param>
        public GetPolTokensRequest(string collectionAddress = default(string), List<string> tokenId = default(List<string>), int page = default(int), PageSizeEnum? pageSize = default(PageSizeEnum?))
        {
            // to ensure "collectionAddress" is required (not null)
            if (collectionAddress == null)
            {
                throw new ArgumentNullException("collectionAddress is a required property for GetPolTokensRequest and cannot be null");
            }
        ...
        /// <example>&quot;0x0004be0357533839ef78038b991fa24ace95544b&quot;</example>
        ...
        /// A list of token ids.
        /// </summary>
        /// <value>A list of token ids.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetPolTokensRequest {\n");
        ...
        {
            return this.Equals(input as GetPolTokensRequest);
        }

        /// <summary>
        /// Returns true if GetPolTokensRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of GetPolTokensRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetPolTokensRequest input)
        {
            if (input == null)
            {
                return false;
