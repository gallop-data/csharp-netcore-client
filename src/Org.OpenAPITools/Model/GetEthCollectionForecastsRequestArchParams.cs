...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "getEthCollectionForecasts_request_arch_params")]
    public partial class GetEthCollectionForecastsRequestArchParams : IEquatable<GetEthCollectionForecastsRequestArchParams>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetEthCollectionForecastsRequestArchParams" /> class.
        /// </summary>
        ...
        public GetEthCollectionForecastsRequestArchParams(string mean = default(string), int lags = default(int), string vol = default(string), int p = default(int), DistEnum? dist = default(DistEnum?))
        {
            this.Mean = mean;
            this.Lags = lags;
            this.Vol = vol;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetEthCollectionForecastsRequestArchParams {\n");
        ...
        {
            return this.Equals(input as GetEthCollectionForecastsRequestArchParams);
        }

        /// <summary>
        /// Returns true if GetEthCollectionForecastsRequestArchParams instances are equal
        /// </summary>
        /// <param name="input">Instance of GetEthCollectionForecastsRequestArchParams to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetEthCollectionForecastsRequestArchParams input)
        {
            if (input == null)
            {
                return false;
