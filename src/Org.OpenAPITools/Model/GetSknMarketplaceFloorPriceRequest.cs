...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "getSknMarketplaceFloorPrice_request")]
    public partial class GetSknMarketplaceFloorPriceRequest : IEquatable<GetSknMarketplaceFloorPriceRequest>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetSknMarketplaceFloorPriceRequest" /> class.
        /// </summary>
        ...
        public GetSknMarketplaceFloorPriceRequest(int page = default(int), PageSizeEnum? pageSize = default(PageSizeEnum?), List<string> collectionAddress = default(List<string>))
        {
            this.Page = page;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetSknMarketplaceFloorPriceRequest {\n");
        ...
        {
            return this.Equals(input as GetSknMarketplaceFloorPriceRequest);
        }

        /// <summary>
        /// Returns true if GetSknMarketplaceFloorPriceRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of GetSknMarketplaceFloorPriceRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetSknMarketplaceFloorPriceRequest input)
        {
            if (input == null)
            {
                return false;
