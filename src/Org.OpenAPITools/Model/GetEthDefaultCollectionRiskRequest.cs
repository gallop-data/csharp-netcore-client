...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "getEthDefaultCollectionRisk_request")]
    public partial class GetEthDefaultCollectionRiskRequest : IEquatable<GetEthDefaultCollectionRiskRequest>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetEthDefaultCollectionRiskRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetEthDefaultCollectionRiskRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetEthDefaultCollectionRiskRequest" /> class.
        /// </summary>
        ...
        public GetEthDefaultCollectionRiskRequest(string collectionAddress = default(string), string holdingPeriod = default(string), ReptCurrEnum? reptCurr = default(ReptCurrEnum?), int amount = default(int), bool drawdown = default(bool))
        {
            // to ensure "collectionAddress" is required (not null)
            if (collectionAddress == null)
            {
                throw new ArgumentNullException("collectionAddress is a required property for GetEthDefaultCollectionRiskRequest and cannot be null");
            }
            this.CollectionAddress = collectionAddress;
            // to ensure "holdingPeriod" is required (not null)
            if (holdingPeriod == null)
            {
                throw new ArgumentNullException("holdingPeriod is a required property for GetEthDefaultCollectionRiskRequest and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetEthDefaultCollectionRiskRequest {\n");
        ...
        {
            return this.Equals(input as GetEthDefaultCollectionRiskRequest);
        }

        /// <summary>
        /// Returns true if GetEthDefaultCollectionRiskRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of GetEthDefaultCollectionRiskRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetEthDefaultCollectionRiskRequest input)
        {
            if (input == null)
            {
                return false;
