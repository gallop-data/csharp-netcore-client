...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "getSolCollectionSummary_request")]
    public partial class GetSolCollectionSummaryRequest : IEquatable<GetSolCollectionSummaryRequest>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetSolCollectionSummaryRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetSolCollectionSummaryRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetSolCollectionSummaryRequest" /> class.
        /// </summary>
        ...
        public GetSolCollectionSummaryRequest(string collectionTag = default(string), string groupBy = default(string), string startDate = default(string), string endDate = default(string), ReptCurrEnum? reptCurr = default(ReptCurrEnum?), bool excludeWash = default(bool))
        {
            // to ensure "collectionTag" is required (not null)
            if (collectionTag == null)
            {
                throw new ArgumentNullException("collectionTag is a required property for GetSolCollectionSummaryRequest and cannot be null");
            }
        ...
        /// <example>&quot;Favorite Programming Language&quot;</example>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetSolCollectionSummaryRequest {\n");
        ...
        {
            return this.Equals(input as GetSolCollectionSummaryRequest);
        }

        /// <summary>
        /// Returns true if GetSolCollectionSummaryRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of GetSolCollectionSummaryRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetSolCollectionSummaryRequest input)
        {
            if (input == null)
            {
                return false;
