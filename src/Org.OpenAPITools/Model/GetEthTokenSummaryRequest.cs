...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "getEthTokenSummary_request")]
    public partial class GetEthTokenSummaryRequest : IEquatable<GetEthTokenSummaryRequest>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetEthTokenSummaryRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetEthTokenSummaryRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetEthTokenSummaryRequest" /> class.
        /// </summary>
        ...
        public GetEthTokenSummaryRequest(string collectionAddress = default(string), List<string> tokenId = default(List<string>), string startDate = default(string), string endDate = default(string), ReptCurrEnum? reptCurr = default(ReptCurrEnum?), bool excludeWash = default(bool))
        {
            // to ensure "collectionAddress" is required (not null)
            if (collectionAddress == null)
            {
                throw new ArgumentNullException("collectionAddress is a required property for GetEthTokenSummaryRequest and cannot be null");
            }
            this.CollectionAddress = collectionAddress;
            // to ensure "tokenId" is required (not null)
            if (tokenId == null)
            {
                throw new ArgumentNullException("tokenId is a required property for GetEthTokenSummaryRequest and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetEthTokenSummaryRequest {\n");
        ...
        {
            return this.Equals(input as GetEthTokenSummaryRequest);
        }

        /// <summary>
        /// Returns true if GetEthTokenSummaryRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of GetEthTokenSummaryRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetEthTokenSummaryRequest input)
        {
            if (input == null)
            {
                return false;
