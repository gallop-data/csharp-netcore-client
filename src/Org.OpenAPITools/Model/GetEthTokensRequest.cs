...
namespace Org.OpenAPITools.Model
{
    ...
    /// GetEthTokensRequest
    /// </summary>
    [DataContract(Name = "getEthTokens_request")]
    public partial class GetEthTokensRequest : IEquatable<GetEthTokensRequest>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetEthTokensRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetEthTokensRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetEthTokensRequest" /> class.
        /// </summary>
        ...
        public GetEthTokensRequest(string collectionAddress = default(string), List<string> tokenId = default(List<string>), int page = default(int), PageSizeEnum? pageSize = default(PageSizeEnum?))
        {
            // to ensure "collectionAddress" is required (not null)
            if (collectionAddress == null)
            {
                throw new ArgumentNullException("collectionAddress is a required property for GetEthTokensRequest and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetEthTokensRequest {\n");
        ...
        {
            return this.Equals(input as GetEthTokensRequest);
        }

        /// <summary>
        /// Returns true if GetEthTokensRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of GetEthTokensRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetEthTokensRequest input)
        {
            if (input == null)
            {
                return false;
