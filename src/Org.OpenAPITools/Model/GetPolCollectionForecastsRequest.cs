...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "getPolCollectionForecasts_request")]
    public partial class GetPolCollectionForecastsRequest : IEquatable<GetPolCollectionForecastsRequest>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetPolCollectionForecastsRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetPolCollectionForecastsRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetPolCollectionForecastsRequest" /> class.
        /// </summary>
        ...
        public GetPolCollectionForecastsRequest(string collectionAddress = default(string), List<int> percentiles = default(List<int>), VoltypeEnum? voltype = default(VoltypeEnum?), int horizon = default(int), string frequency = default(string), DistEnum? dist = default(DistEnum?), string startDate = default(string), string endDate = default(string), bool returnPriceForecasts = default(bool), decimal alpha = default(decimal), ReptCurrEnum? reptCurr = default(ReptCurrEnum?), bool excludeWash = default(bool), GetEthCollectionForecastsRequestArchParams archParams = default(GetEthCollectionForecastsRequestArchParams))
        {
            // to ensure "collectionAddress" is required (not null)
            if (collectionAddress == null)
            {
                throw new ArgumentNullException("collectionAddress is a required property for GetPolCollectionForecastsRequest and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetPolCollectionForecastsRequest {\n");
        ...
        {
            return this.Equals(input as GetPolCollectionForecastsRequest);
        }

        /// <summary>
        /// Returns true if GetPolCollectionForecastsRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of GetPolCollectionForecastsRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetPolCollectionForecastsRequest input)
        {
            if (input == null)
            {
                return false;
