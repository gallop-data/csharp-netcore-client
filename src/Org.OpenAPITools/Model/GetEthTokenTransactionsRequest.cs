...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "getEthTokenTransactions_request")]
    public partial class GetEthTokenTransactionsRequest : IEquatable<GetEthTokenTransactionsRequest>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetEthTokenTransactionsRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetEthTokenTransactionsRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetEthTokenTransactionsRequest" /> class.
        /// </summary>
        ...
        public GetEthTokenTransactionsRequest(string collectionAddress = default(string), string tokenId = default(string), int page = default(int), PageSizeEnum? pageSize = default(PageSizeEnum?), string startDate = default(string), int startBlockNumber = default(int), string endDate = default(string))
        {
            // to ensure "collectionAddress" is required (not null)
            if (collectionAddress == null)
            {
                throw new ArgumentNullException("collectionAddress is a required property for GetEthTokenTransactionsRequest and cannot be null");
            }
            this.CollectionAddress = collectionAddress;
            // to ensure "tokenId" is required (not null)
            if (tokenId == null)
            {
                throw new ArgumentNullException("tokenId is a required property for GetEthTokenTransactionsRequest and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetEthTokenTransactionsRequest {\n");
        ...
        {
            return this.Equals(input as GetEthTokenTransactionsRequest);
        }

        /// <summary>
        /// Returns true if GetEthTokenTransactionsRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of GetEthTokenTransactionsRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetEthTokenTransactionsRequest input)
        {
            if (input == null)
            {
                return false;
