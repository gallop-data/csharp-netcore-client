...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "getEthWalletNFTs_request")]
    public partial class GetEthWalletNFTsRequest : IEquatable<GetEthWalletNFTsRequest>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetEthWalletNFTsRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetEthWalletNFTsRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetEthWalletNFTsRequest" /> class.
        /// </summary>
        ...
        public GetEthWalletNFTsRequest(string walletAddress = default(string), int page = default(int), PageSizeEnum? pageSize = default(PageSizeEnum?))
        {
            // to ensure "walletAddress" is required (not null)
            if (walletAddress == null)
            {
                throw new ArgumentNullException("walletAddress is a required property for GetEthWalletNFTsRequest and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetEthWalletNFTsRequest {\n");
        ...
        {
            return this.Equals(input as GetEthWalletNFTsRequest);
        }

        /// <summary>
        /// Returns true if GetEthWalletNFTsRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of GetEthWalletNFTsRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetEthWalletNFTsRequest input)
        {
            if (input == null)
            {
                return false;
