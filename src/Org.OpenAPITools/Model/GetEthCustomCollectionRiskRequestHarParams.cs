...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "getEthCustomCollectionRisk_request_har_params")]
    public partial class GetEthCustomCollectionRiskRequestHarParams : IEquatable<GetEthCustomCollectionRiskRequestHarParams>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetEthCustomCollectionRiskRequestHarParams" /> class.
        /// </summary>
        ...
        /// <param name="q">Order of the lagged (transformed) conditional variance..</param>
        /// <param name="dist">Return distribution assumed..</param>
        public GetEthCustomCollectionRiskRequestHarParams(string mean = default(string), int lags = default(int), string vol = default(string), List<int> p = default(List<int>), int q = default(int), DistEnum? dist = default(DistEnum?))
        {
            this.Mean = mean;
            this.Lags = lags;
            this.Vol = vol;
        ...
        /// </summary>
        /// <value>Order of the lagged (transformed) conditional variance.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetEthCustomCollectionRiskRequestHarParams {\n");
        ...
        {
            return this.Equals(input as GetEthCustomCollectionRiskRequestHarParams);
        }

        /// <summary>
        /// Returns true if GetEthCustomCollectionRiskRequestHarParams instances are equal
        /// </summary>
        /// <param name="input">Instance of GetEthCustomCollectionRiskRequestHarParams to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetEthCustomCollectionRiskRequestHarParams input)
        {
            if (input == null)
            {
                return false;
