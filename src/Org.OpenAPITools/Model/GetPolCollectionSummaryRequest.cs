...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "getPolCollectionSummary_request")]
    public partial class GetPolCollectionSummaryRequest : IEquatable<GetPolCollectionSummaryRequest>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetPolCollectionSummaryRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetPolCollectionSummaryRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetPolCollectionSummaryRequest" /> class.
        /// </summary>
        ...
        public GetPolCollectionSummaryRequest(string collectionAddress = default(string), string groupBy = default(string), string startDate = default(string), string endDate = default(string), ReptCurrEnum? reptCurr = default(ReptCurrEnum?), bool excludeWash = default(bool))
        {
            // to ensure "collectionAddress" is required (not null)
            if (collectionAddress == null)
            {
                throw new ArgumentNullException("collectionAddress is a required property for GetPolCollectionSummaryRequest and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetPolCollectionSummaryRequest {\n");
        ...
        {
            return this.Equals(input as GetPolCollectionSummaryRequest);
        }

        /// <summary>
        /// Returns true if GetPolCollectionSummaryRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of GetPolCollectionSummaryRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetPolCollectionSummaryRequest input)
        {
            if (input == null)
            {
                return false;
