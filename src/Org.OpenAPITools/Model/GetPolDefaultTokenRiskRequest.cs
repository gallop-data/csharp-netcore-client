...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "getPolDefaultTokenRisk_request")]
    public partial class GetPolDefaultTokenRiskRequest : IEquatable<GetPolDefaultTokenRiskRequest>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetPolDefaultTokenRiskRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetPolDefaultTokenRiskRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetPolDefaultTokenRiskRequest" /> class.
        /// </summary>
        ...
        public GetPolDefaultTokenRiskRequest(string collectionAddress = default(string), List<string> tokenId = default(List<string>), string holdingPeriod = default(string), ReptCurrEnum? reptCurr = default(ReptCurrEnum?), bool drawdown = default(bool))
        {
            // to ensure "collectionAddress" is required (not null)
            if (collectionAddress == null)
            {
                throw new ArgumentNullException("collectionAddress is a required property for GetPolDefaultTokenRiskRequest and cannot be null");
            }
            this.CollectionAddress = collectionAddress;
            // to ensure "tokenId" is required (not null)
            if (tokenId == null)
            {
                throw new ArgumentNullException("tokenId is a required property for GetPolDefaultTokenRiskRequest and cannot be null");
            }
            this.TokenId = tokenId;
            // to ensure "holdingPeriod" is required (not null)
            if (holdingPeriod == null)
            {
                throw new ArgumentNullException("holdingPeriod is a required property for GetPolDefaultTokenRiskRequest and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetPolDefaultTokenRiskRequest {\n");
        ...
        {
            return this.Equals(input as GetPolDefaultTokenRiskRequest);
        }

        /// <summary>
        /// Returns true if GetPolDefaultTokenRiskRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of GetPolDefaultTokenRiskRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetPolDefaultTokenRiskRequest input)
        {
            if (input == null)
            {
                return false;
