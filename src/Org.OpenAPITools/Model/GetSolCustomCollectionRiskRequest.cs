...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "getSolCustomCollectionRisk_request")]
    public partial class GetSolCustomCollectionRiskRequest : IEquatable<GetSolCustomCollectionRiskRequest>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetSolCustomCollectionRiskRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetSolCustomCollectionRiskRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetSolCustomCollectionRiskRequest" /> class.
        /// </summary>
        ...
        public GetSolCustomCollectionRiskRequest(string collectionTag = default(string), string holdingPeriod = default(string), List<int> percentiles = default(List<int>), int amount = default(int), DistEnum? dist = default(DistEnum?), string startDate = default(string), string endDate = default(string), bool winsOutliers = default(bool), decimal riskFreeRate = default(decimal), string frequency = default(string), ReptCurrEnum? reptCurr = default(ReptCurrEnum?), bool excludeWash = default(bool), bool drawdown = default(bool), GetEthCustomCollectionRiskRequestArcParams arcParams = default(GetEthCustomCollectionRiskRequestArcParams), GetEthCustomCollectionRiskRequestGarParams garParams = default(GetEthCustomCollectionRiskRequestGarParams), GetEthCustomCollectionRiskRequestHarParams harParams = default(GetEthCustomCollectionRiskRequestHarParams))
        {
            // to ensure "collectionTag" is required (not null)
            if (collectionTag == null)
            {
                throw new ArgumentNullException("collectionTag is a required property for GetSolCustomCollectionRiskRequest and cannot be null");
            }
            this.CollectionTag = collectionTag;
            // to ensure "holdingPeriod" is required (not null)
            if (holdingPeriod == null)
            {
                throw new ArgumentNullException("holdingPeriod is a required property for GetSolCustomCollectionRiskRequest and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetSolCustomCollectionRiskRequest {\n");
        ...
        {
            return this.Equals(input as GetSolCustomCollectionRiskRequest);
        }

        /// <summary>
        /// Returns true if GetSolCustomCollectionRiskRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of GetSolCustomCollectionRiskRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GetSolCustomCollectionRiskRequest input)
        {
            if (input == null)
            {
                return false;
